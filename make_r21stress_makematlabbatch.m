...
for i=1:(length(filenames)-1)
  filename=strcat(filenames{i},',1');
  matlabbatch{i}.spm.spatial.normalise.estwrite.subj.source = {filename};
  matlabbatch{i}.spm.spatial.normalise.estwrite.subj.wtsrc = '';
  matlabbatch{i}.spm.spatial.normalise.estwrite.subj.resample = {filename};
  matlabbatch{i}.spm.spatial.normalise.estwrite.eoptions.template = {SPM_T1_location};
