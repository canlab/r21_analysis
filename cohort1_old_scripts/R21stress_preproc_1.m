...
cd '/Volumes/r21stress/Imaging/Experimentals/Stress/Experimental_5979/par_rec'
...
diary qc_report.txt
[g, spikes, gtrim, nuisance_covs, snr] = scn_session_spike_id(imgs{i,1});
diary off
...
% Go to the directory where the functional images are for a single subject:
%cd /Volumes/Cort/Imaging/CORT/cort1523
...
%for i = 1:2%length(nruns)
PREPROC.func_files = imgs
PREPROC.TR = 1.7;
PREPROC.num_vols_per_run = [306 306]; 
% PREPROC.num_vols_per_run = [5 5];%DBG joew
